      ...
      <div className="relative z-10 container mx-auto px-6 py-24">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button size="lg" variant="outline" className="bg-white/10 border-white/20 text-white hover:bg-white hover:text-primary text-lg px-8 py-4">
              Post a Contract
            </Button>
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-lg px-8 py-4 shadow-glow">
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 p-6 text-center">
              <Award className="w-8 h-8 mx-auto mb-3 text-primary-glow" />
